"""
Django settings for tango_39090 project.
...
WSGI_APPLICATION = 'tango_39090.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tango_39090 API",
    "DESCRIPTION": "API documentation for tango_39090 App",
    "VERSION": "v1",
}
